...
const Custom_Fonts_Icons = {
    ...
    'remove': el(
      ...
      'removeVariation': el(
        'svg',
        { width: 16, height: 16, viewBox: '0 0 16 16', fill: 'none', xmlns: 'http://www.w3.org/2000/svg' , className: 'cursor-pointer remove-icon h-[40px]', onClick: () => handleVariationRemove(variation.id) },
        el('path', {
      ...
      'removeVariation2': el(
        'svg',
        { width: 16, height: 16, viewBox: '0 0 16 16', fill: 'none', xmlns: 'http://www.w3.org/2000/svg' },
        el('path', { d: 'M8.00078 0.800049C4.00078 0.800049 0.800781 4.00005 0.800781 8.00005C0.800781 12 4.00078 15.2 8.00078 15.2C12.0008 15.2 15.2008 12 15.2008 8.00005C15.2008 4.00005 12.0008 0.800049 8.00078 0.800049ZM8.00078 13.6C4.88078 13.6 2.40078 11.12 2.40078 8.00005C2.40078 4.88005 4.88078 2.40005 8.00078 2.40005C11.1208 2.40005 13.6008 4.88005 13.6008 8.00005C13.6008 11.12 11.1208 13.6 8.00078 13.6ZM4.80078 7.20005V8.80005H11.2008V7.20005H4.80078Z', fill: 'rgb(230 80 84 / 1)' }),
      ),      
      'arrowIcon': el(
        'svg',
        { width: 12, height: 8, viewBox: '0 0 12 8', className: 'arrow-icon h-[40px]', fill: 'none', xmlns: 'http://www.w3.org/2000/svg', onClick: () => setToggleView(false) },
        el('path', {
      ...
      'arrowIcon2': el(
        'svg',
        { width: 12, height: 8, viewBox: '0 0 12 8', className: 'arrow-icon h-[40px]', fill: 'none', xmlns: 'http://www.w3.org/2000/svg', onClick: () => setToggleView(true) },
        el('path', {
      ...
      'cancelButton': el(
        'svg',
        { xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 20 20', width: 20, height: 12, ariaHidden: true, focusable: false, className: 'mr-[2px]' },
        el('path', { d: 'M13 11.8l6.1-6.3-1-1-6.1 6.2-6.1-6.2-1 1 6.1 6.3-6.5 6.7 1 1 6.5-6.6 6.5 6.6 1-1z' }),
      ),
      'AddFontVariation': el(
        'svg',
        { width: 16, height: 16, viewBox: '0 0 16 16', fill: 'none', xmlns: 'http://www.w3.org/2000/svg' },
        el('path', { d: 'M7.9998 0.800049C3.9998 0.800049 0.799805 4.00005 0.799805 8.00005C0.799805 12 3.9998 15.2 7.9998 15.2C11.9998 15.2 15.1998 12 15.1998 8.00005C15.1998 4.00005 11.9998 0.800049 7.9998 0.800049ZM7.9998 13.6C4.8798 13.6 2.3998 11.12 2.3998 8.00005C2.3998 4.88005 4.8798 2.40005 7.9998 2.40005C11.1198 2.40005 13.5998 4.88005 13.5998 8.00005C13.5998 11.12 11.1198 13.6 7.9998 13.6ZM8.7998 4.80005H7.1998V7.20005H4.7998V8.80005H7.1998V11.2H8.7998V8.80005H11.1998V7.20005H8.7998V4.80005Z', fill: '#3858E9' }),
      ),
      'AdvancedOptionIcon': el(
        'svg',
        { width: 6, height: 8, viewBox: '0 0 6 8', fill: 'none', xmlns: 'http://www.w3.org/2000/svg' },
        el('path', { d: 'M0.400391 0.800049L5.20039 4.02405L0.400391 7.20005L0.400391 0.800049Z', fill: '#3858E9' }),
      ),
      'removeVariation3': el(
        'svg',
        { width: 40, height: 40, viewBox: '0 0 16 16', fill: 'none', xmlns: 'http://www.w3.org/2000/svg', className: 'cursor-pointer remove-icon h-[40px]', onClick: () => handleVariationRemove(variation.id) },
        el('path', {
          d: 'M8.00078 0.800049C4.00078 0.800049 0.800781 4.00005 0.800781 8.00005C0.800781 12 4.00078 15.2 8.00078 15.2C12.0008 15.2 15.2008 12 15.2008 8.00005C15.2008 4.00005 12.0008 0.800049 8.00078 0.800049ZM8.00078 13.6C4.88078 13.6 2.40078 11.12 2.40078 8.00005C2.40078 4.88005 4.88078 2.40005 8.00078 2.40005C11.1208 2.40005 13.6008 4.88005 13.6008 8.00005C13.6008 11.12 11.1208 13.6 8.00078 13.6ZM4.80078 7.20005V8.80005H11.2008V7.20005H4.80078Z',
          fill: 'rgb(230 80 84 / 1)',
        }),
