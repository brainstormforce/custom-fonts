...
const EditFont = ( props ) => {
  ...
  const [updatedFontName, setUpdatedFontName] = useState(fontName);
  ...
  <div className="col-span-4 bg-white px-4 pt-5 pb-4 lg:p-[2em] sm:p-6">
                    ...
                    <div>
                      {fontType === "local" && (
                        <EditLocalFont fontId={font} fontName={fontName} />
                      )}
                      {fontType === "google" && (
                        <EditGoogleFont fontId={font} fontName={fontName} />
                      )}
                    </div>
                  </div>
                  <div className="col-span-8 bg-[#F6F7F7] px-4 pt-5 pb-4 lg:p-[2em] sm:p-6">
                    ...
                    <div className="py-5 divide-y">
                      <div>
                        {fontType === "local" && (
                          <EditLocalPreviewItem fontId={font} fontName={fontName} />
                        )}
                        {fontType === "google" && (
                          <EditGooglePreviewItem fontId={font} fontName={fontName} />
                        )}
                      </div>
                    </div>
                  </div>
