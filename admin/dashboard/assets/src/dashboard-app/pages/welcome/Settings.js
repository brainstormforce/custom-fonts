				...
				<label className="flex items-center gap-1.5 cursor-pointer relative">
					<Switch.Group as="div" className="flex items-center">
						<Switch
							...
							className="group relative inline-flex h-5 w-10 flex-shrink-0 cursor-pointer items-center justify-center rounded-full focus:outline-none focus:ring-2 focus:ring-[#3858e9] focus:ring-offset-2"
							>
