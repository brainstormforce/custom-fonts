...
if ( ! class_exists( 'Custom_Fonts_WP_Background_Process' ) ) {
	...
	/**
	 * Custom_Fonts_WP_Background_Process class.
	 */
	class Custom_Fonts_WP_Background_Process extends Custom_Fonts_WP_Async_Request {
		...
		public function schedule_cron_healthcheck( $schedules ) {
			...
			$schedules[ $this->cron_interval_identifier ] = array(
				...
				'display'  => sprintf( __( 'Every %d Minutes' ), $interval ), // phpcs:ignore WordPress.WP.I18n.MissingTextDomain
			);
